...
//        
    ...
    // Call the show_files short code directly to display thumbnails of 
...
//                . "<a href={$zip_url}>" . basename($zipname) . "</a>.<br /><br />"
    ...
    $message = "Hi {$wp_user->display_name},<br/><br/>
        ...
        <p>You have submitted the following files :</p>
                $files_content
        <br/><br/>
    ...
    // Note : Do NOT exit or die when finished, so that workflow processing will continue.
}
